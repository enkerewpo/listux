...
class SettingsManager {
  ...
  func clearAllData(modelContext: ModelContext) {
    do {
      print("SettingsManager: Starting to clear all local data")
      ...
      print("SettingsManager: Found \(preferences.count) preferences to delete")
      ...
      print("SettingsManager: Found \(favoriteMessages.count) favorite messages to delete")
      ...
      print("SettingsManager: All local persistent data has been cleared successfully")
      ...
      do {
        ...
        print("SettingsManager: Verification - \(remainingPreferences.count) preferences and \(remainingFavorites.count) favorite messages remaining")
      } catch {
        print("SettingsManager: Error verifying data clearing: \(error)")
      }
      ...
      print("SettingsManager: Cleared UserDefaults preferences")
      ...
      print("SettingsManager: Failed to clear local data: \(error)")
    }
  }
}
