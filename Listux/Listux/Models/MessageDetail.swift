...
struct MessageDiff {
  ...
  init(
    filePath: String, additions: [DiffLine] = [], deletions: [DiffLine] = [],
    context: [DiffLine] = []
  ) {
...
struct ThreadNavigation {
  ...
  init(
    parentMessage: String? = nil, childMessages: [String] = [], siblingMessages: [String] = [],
    threadStart: String? = nil, threadEnd: String? = nil
  ) {
...
struct MessageMetadata {
  ...
  init(
    author: String, date: Date, recipients: [String], ccRecipients: [String], subject: String,
    messageId: String, permalink: String, rawUrl: String
  ) {
    self.author = author
    self.date = date
